  ...
  <div class="row">
    ...
    <div class="league-summary-container">
      ...
      <div class="league-card-box">
        ...
        <ul class="league-card-body">
          ...
          <li>یک میلیون تومان کد تخفیف اسنپ کارفیکس (ویژه آذر و دی)</li>
          <li>یک میلیون تومان کد تخفیف اسنپ‌شاپ</li>
          <li>۵ گیگ اینترنت یک‌ماهه رایگان</li>
          <li>استعلام رایگان خلافی (یک بار در ماه)</li>
          <li>جایزه نقدی یک میلیون تومانی</li>
          <li>امکان تماس مستقیم با پشتیبانی</li>
        </ul>
      </div>
      ...
      <div class="league-card-box">
        ...
        <ul class="league-card-body">
          <li>۸۰ لیتر بنزین معادل ۲۴۰ هزار تومان اعتبار</li>
          <li>۵۰۰ هزار تومان کد تخفیف اسنپ کارفیکس (ویژه آذر و دی)</li>
          <li>۵۰۰ هزار تومان کد تخفیف اسنپ‌شاپ</li>
          <li>۳ گیگ اینترنت یک‌ماهه رایگان</li>
          <li>استعلام رایگان خلافی خودرو (یک بار در ماه)</li>
        </ul>
      </div>
      ...
      <div class="league-card-box">
        ...
        <ul class="league-card-body">
          <li>۲۰ لیتر بنزین معادل ۶۰ هزار تومان اعتبار</li>
          <li>۲۵۰ هزار تومان کد تخفیف اسنپ کارفیکس (ویژه آذر و دی)</li>
          <li>۲۵۰ هزار تومان کد تخفیف اسنپ‌شاپ</li>
        </ul>
      </div>
      ...
      <div class="league-card-box">
        ...
        <ul class="league-card-body">
          ...
          <li>۱۵۰ هزار تومان کد تخفیف اسنپ کارفیکس (ویژه آذر و دی)</li>
        </ul>
      </div>
    </div>
    ...
    <div class="text-end mt-3">
      <p style="margin: 0; text-align: center;">
        اگر در ماه‌های مهر، آبان و آذر در لیگ برتر قرار بگیرید، عنوان کاپیتانی به شما تعلق می‌گیرد و امکان دریافت وام ۴۰ میلیون‌تومانی یا جایزه نقدی ۴ میلیون‌تومانی را دارید.
      </p>
    </div>
  </div>
  ...
  <div class="col-md-12 ">
    <div class="loyal-benefit">
      ...
      <p class="loyal-benefit-alert">
        فرصت دریافت جایزه نقدی و هزینه خرید بنزین تا روز دهم هر ماه است.
      </p>

      <p class="loyal-benefit-alert">
        فرصت ثبت درخواست جوایز اسنپ شاپ، بسته اینترنت و استعلام خلافی خودرو تا روز دهم هر ماه و مهلت استفاده از این جوایز تا پایان ماه است.
      </p>

      <p class="loyal-benefit-alert">
        فرصت ثبت درخواست و استفاده از جوایز اسنپ کارفیکس ( به غیر از خدمات کارواش) تا پایان ماه است.
      </p>

      <p class="loyal-benefit-alert">
        امکان ثبت درخواست جایزه کاپیتانی تا روز دهم هر ماه از طریق اپلیکیشن فراهم است.
      </p>

      <p class="loyal-benefit-alert">
        درصورتی که امتیاز کاربر راننده ۴.۷ باشد، از روز ۱۱ تا ۱۵ هر ماه جایزه نقدی کاپیتانی واریز می‌شود.
      </p>

      <p class="loyal-benefit-alert">
        فرصت تماس مستقیم با پشتیبانی برای لیگ برتر از اول تا سی‌ام هر ماه در دسترس خواهد بود.
      </p>

      <p class="loyal-benefit-alert">
        امکان ثبت درخواست وام کاپیتانی تا روز پنجم هر ماه از طریق اپلیکیشن فراهم است.
      </p>
...
<style>
  ...
  @media (max-width: 768px) {
    ...
    .loyal-video video {
      max-width: 100%;
      /* اطمینان از پر شدن عرض در موبایل */
      margin: 10px auto;
    }

    .loyal-video h2 {
      font-size: 1.2rem;
      /* کاهش اندازه فونت عنوان در موبایل */
      text-align: center;
    }
  }
</style>
  ...
  <section class="faq-section">
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>لیگ رانندگان اسنپ طرحی است برای قدردانی از کاربران راننده فعال و فراهم‌کردن امکان استفاده از مزایایی فراتر از تسهیلات معمول باشگاه رانندگان. در این طرح، کاربران راننده بر اساس استان محل فعالیت و مبلغ سفر، «اس‌پی» دریافت کرده و با توجه به مجموع اس‌پی‌های ماه قبل، در یکی از لیگ‌های اسنپ قرار می‌گیرند و از جوایز ویژه‌ی همان لیگ بهره‌مند می‌شوند.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>«اس‌پی» واحد امتیاز لیگ رانندگان اسنپ است. پس از انجام هر سفر، با توجه به مبلغ سفر و استان محل فعالیت، مقدار مشخصی اس‌پی به شما تعلق می‌گیرد. مجموع امتیازهای شما در پایان ماه، جایگاهتان را در لیگ مشخص کرده و میزان جوایز قابل دریافت را تعیین می‌کند.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>اگر در یکی از ۸ استان فعال در لیگ رانندگان اسنپ (تهران، البرز، خراسان رضوی، اصفهان، فارس، خوزستان، قم و آذربایجان شرقی) فعالیت می‌کنید، یک ماه فرصت دارید با انجام سفرهای اسنپی، براساس قیمت سفر (قبل از کسر کمیسیون)، اس‌پی جمع‌آوری کنید. در پایان ماه، باتوجه‌‌به مجموع اس‌پی‌هایی که به‌دست آورده‌اید، در یکی از لیگ‌ها قرار می‌گیرید و می‌توانید از جوایز مربوط به همان لیگ استفاده کنید.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>حداقل اس‌پی موردنیاز هر لیگ به این صورت است:</p>
        <ul>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>جایگاه شما در لیگ رانندگان به‌صورت ماهانه محاسبه می‌شود و ابتدای هر ماه باتوجه‌به اس‌پی‌هایی که در ماه قبل دریافت کرده‌اید، وارد یکی از لیگ‌های سبز، نقره‌ای، طلایی و برتر می‌شوید.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>فرصت دریافت جایزه نقدی و هزینه خرید بنزین تا روز دهم هر ماه است.</p>
        <p>فرصت ثبت درخواست جوایز اسنپ شاپ، بسته اینترنت و استعلام خلافی خودرو تا روز دهم هر ماه و مهلت استفاده از این جوایز تا پایان ماه است.</p>
        <p>فرصت ثبت درخواست و استفاده از جوایز اسنپ کارفیکس تا پایان ماه است.</p>
        <p>امکان ثبت درخواست جایزه کاپیتانی تا روز دهم هر ماه از طریق اپلیکیشن فراهم است.</p>
        <p>درصورتی که امتیاز کاربر راننده ۴.۷ باشد، از روز ۱۱ تا ۱۵ هر ماه جایزه نقدی کاپیتانی واریز می‌شود.</p>
        <p>فرصت تماس مستقیم با پشتیبانی برای لیگ برتر از اول تا سی‌ام هر ماه در دسترس خواهد بود.</p>
        <p>امکان ثبت درخواست وام کاپیتانی تا روز پنجم هر ماه از طریق اپلیکیشن فراهم است.</p>
        <p>توجه داشته باشید برای فعال شدن جوایز، امتیاز شما در اپلیکیشن رانندگان اسنپ باید حداقل ۴.۷ باشد.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>برای مشاهده جوایزی که هر ماه درخواست داده‌اید کافی است وارد اپلیکیشن رانندگان اسنپ شده و به بخش لیگ رانندگان بروید. سپس روی گزینه «مشاهده جوایز دریافتی» بزنید تا فهرست تمام جایزه‌های فعال‌شده ماه فعلی‌تان نمایش داده شود. اگر هنوز از کدهای تخفیف خود استفاده نکرده‌اید، می‌توانید از همین بخش به آن‌ها دسترسی داشته باشید.</p>
        <p>توجه داشته باشید که فرصت ثبت درخواست بنزین و کد تخفیف اسنپ‌شاپ تا روز دهم ماه و مهلت استفاده از آن‌ها تا پایان همان ماه خواهد بود.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>سؤالات یا مشکلات احتمالی را از طریق ثبت درخواست در اپلیکیشن رانندگان اسنپ یا از طریق تماس با تیم پشتیبانی اسنپ مطرح کنید.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>هزینه خرید بنزین حداکثر یک روز پس از ثبت درخواست، به اعتبار اسنپی‌تان در اپلیکیشن رانندگان اسنپ اضافه می‌شود. کد تخفیف را هم در لحظه ثبت درخواست، می‌توانید دریافت کنید. برای استفاده از کدهای تخفیف فعالتان می‌توانید از بخش «مشاهده جوایز دریافتی» به آن‌ها دسترسی داشته باشید.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>چنانچه یک‌بار از کد تخفیف خود استفاده کرده‌اید این کد دیگر قابل‌استفاده نیست. برای استفاده از کد تخفیف اسنپ‌شاپ، لازم است همه خریدهایتان را در یک نوبت انجام دهید. توجه داشته باشید مهلت ثبت درخواست کد تخفیف اسنپ‌شاپ تا روز دهم هر ماه و فرصت استفاده از آن تا پایان همان ماه شمسی است.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>جایگاه کاپیتان، ویژه کاربران راننده فعالی است که سه ماه متوالی در لیگ برتر قرار بگیرند. به طور مثال، اگر در ماه‌های تیر، مرداد و شهریور در لیگ برتر قرار بگیرید، در ابتدای ماه مهر کاپیتان می‌شوید. تا زمانی که در ماه‌های بعد نیز لیگ برتری بمانید، جایگاه کاپیتانی شما تثبیت می‌شود.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>در بازه زمانی ۱ تا ۱۰ هر ماه، فقط جوایز لیگی که در آن هستید برایتان فعال می‌شود. ابتدا مطمئن شوید که لیگ درست را انتخاب کرده‌اید. اگر با وجود انتخاب لیگ درست هنوز جوایز غیرفعال هستند، ممکن است به دلایل زیر باشد:</p>
        <ul>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>اس‌پی به سفرهای بین‌استانی تعلق می‌گیرد که مبدأ آن‌ها در شهرهای تحت پوشش لیگ رانندگان (هشت شهر فعال) باشد. توجه داشته باشید حداکثر امتیاز دریافتی برای هر سفر بین‌استانی ۵۰ اس‌پی است.</p>
      </div>
    </div>
